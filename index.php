...
<html lang="en">
   <head>
      ...
      <link href="images/cat_icon.png" rel="icon">
                        ...
                        <div class="carousel-item active">
                           <div class="container-fluid">
                              <div class="carousel-caption relative">
                                 <div class="bluid">
                                    <h1>Saving <br> Cat's Paw</h1>
                                    <p>When the buying stops, the killing can too
                                    </p>
                                    <!-- <a class="read_more" href="about.php">About Company </a> -->
      ...
      <div class="chose">
         <div class="container">
            <div class="row d_flex">
               ...
               <div class="col-lg-5 col-md-4">
                  <div class="chose_box">
                     <i><img src="images/money.png" alt="#"/></i>
                     <h3>Happy Cats </h3>
                     <strong>900+</strong>
                     <!-- <a class="read_more" href="Javascript:void(0)">Read More</a> -->
                  </div>
      ...
      <div class="contact">
         <div class="container">
            <div class="row ">
               <div class="col-md-6">
                  <div class="titlepage text_align_left">
                     <h2 style="color: #003377;">Get In Touch</h2>
                  </div>
               ...
               <div class="col-md-6">
                  <div class="titlepage text_align_left">
                     <h2 style="color: #003377;">Project Introduction</h2>
                  </div>
                           ...
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="clientsl_text">
                                    <i><img src="images/cat1.jpg" alt="#"/></i>
                                    <h3>Deno <img src="images/icon.png" alt="#"/></h3>
                                    <p style="font-family: 'Poppins', sans-serif;">Every time you eat a mangosteen, a cat loses a toe bean! Save the paws, skip the mangosteen! Join us in the noble fight to protect our feline friends’ precious little beans. Because no snack is worth the cost of a kitty toe!”</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="container">
                              <div class="carousel-caption posi_in">
                                 <div class="clientsl_text">
                                    <i><img src="images/cat1.jpg" alt="#"/></i>
                                    <h3>Deno <img src="images/icon.png" alt="#"/></h3>
                                    <p>Every time you eat a mangosteen, a cat loses a toe bean! Save the paws, skip the mangosteen! Join us in the noble fight to protect our feline friends’ precious little beans. Because no snack is worth the cost of a kitty toe!”</p>
                                 </div>
                              </div>
                           </div>
                        </div>
